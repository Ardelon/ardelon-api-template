...
exports.addDumyController = void 0;
const models_1 = require("../../db/models");
const addDumyController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const dumy = new models_1.dumySchema({ email });
        yield dumy.save();
...
exports.addDumyController = addDumyController;
